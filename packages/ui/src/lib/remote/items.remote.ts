...
import { getFilesByItem, getItemsByIds, queryItems, type QueryItemsInput } from "@contfu/contfu";
...
export const getItemFilesQuery = query(v.pipe(v.string(), v.minLength(1)), (id) => {
  return getFilesByItem(id);
});
