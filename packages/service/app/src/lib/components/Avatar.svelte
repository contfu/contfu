...
{:else}
	<div
		class="bg-primary-100 text-primary-600 ring-primary-400 dark:bg-primary-900 dark:text-primary-400 dark:ring-primary-500 flex h-12 w-12 items-center justify-center rounded-full ring-1"
	>
