...
<svelte:head>
  <title>Legal Notice - Contfu</title>
</svelte:head>
...
<div class="page-shell px-4 py-24">
  ...
  <div class="prose prose-gray dark:prose-invert max-w-none">
    ...
    <section class="mb-8">
      ...
      <p class="mb-4 text-gray-600 dark:text-gray-300">[REPRESENTATIVE NAME]</p>
    </section>
    ...
    <section class="mb-8">
      ...
      <p class="mb-4 text-gray-600 dark:text-gray-300">
        Responsible for content according to Section 55 (2) RStV:<br />
    ...
    <section class="mb-8">
      ...
      <p class="mb-4 text-gray-600 dark:text-gray-300">
        ...
        on these pages according to general laws. However, we are not obligated
