...
<div class="flex min-h-[calc(100vh-8rem)] items-center justify-center px-4 py-12">
	<div class="auth-shell">
		<div class="mb-8">
			<p class="text-xs text-muted-foreground mb-1">session/authenticate</p>
			<h1 class="text-xl font-semibold">
				<span class="text-primary">></span> Sign in
			</h1>
		</div>
		...
		<form onsubmit={handleEmailLogin} class="space-y-4">
			...
			<div class="space-y-1.5">
				...
				<Input type="password" id="password" bind:value={password} placeholder="--------" required class="bg-card" />
			</div>
