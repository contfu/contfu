...
- Update Bun runtime compatibility.
...
- Removed dead code and reduced complexity in server dispatchers.
...
- HTTP and file handling logic moved to `@contfu/contfu`; server now composes from `ContfuInstance`
