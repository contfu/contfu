...
2. **Understand** — before doing anything else, make sure you fully understand the issue. Ask yourself: do I know *what* needs to change, *why* it needs to change, and *what the end state looks like*? If any of these are unclear, use `AskUserQuestion` to resolve them. See "Clarification guidelines" below.
