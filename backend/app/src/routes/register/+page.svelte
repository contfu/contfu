	...
	<div class="container mx-auto px-4">
		<div class="mx-auto max-w-md">
			<div class="rounded-lg bg-white p-8 shadow-md dark:bg-gray-800">
				<h2 class="mb-6 text-center text-3xl font-bold text-gray-900 dark:text-white">Create your account</h2>
				...
				<p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
					...
					<a href="/login" class="text-primary-500 hover:text-primary-600 font-medium">
						Sign in
					</a>
				</p>
			</div>
