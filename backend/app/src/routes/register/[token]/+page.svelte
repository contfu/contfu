	...
	<div class="container mx-auto px-4">
		<div class="mx-auto max-w-md">
			<div class="rounded-lg bg-white p-8 shadow-md dark:bg-gray-800">
				<h2 class="mb-2 text-center text-3xl font-bold text-gray-900 dark:text-white">Welcome, {data.userData.name}!</h2>
				<p class="mb-6 text-center text-gray-600 dark:text-gray-400">Please complete your registration</p>
				...
				>
					<div>
						...
						{#if form?.errors?.password}
							<div class="mt-1 text-sm text-red-600 dark:text-red-400">{form.errors.password}</div>
						{/if}
					</div>
