---
name: z-next
description: Pick the next issue to work on from the GitHub project board. Analyzes "Ready" issues for dependencies and conflicts with in-progress work, and recommends the best candidate.
---
...
6. **Create branch** — create a concise branch from `origin/main`:
   ...
   - Run: `git fetch origin main` then `git checkout -b <branch-name> origin/main`
